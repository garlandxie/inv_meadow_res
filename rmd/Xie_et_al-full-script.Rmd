...
**Reorganize data.** First, subset the seed bank dataset to have six sites that are congruent with the above-ground biomass dataset. This applies to both the spring and fall sampling season.

```{r subset fall seed bank}
sb_fall_six_sites <- seed_bank_fall %>%
  janitor::clean_names() %>%
  dplyr::filter(
